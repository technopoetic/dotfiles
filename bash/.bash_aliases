...
alias gup='git fetch && git rebase --rebase-merges'
...
alias knonprod='kuse gke_vst-main-nonprod_us-east1_nonprod3-use1'
alias kprod='kuse gke_vst-main-prod_us-east1_prod1-use1'
alias kprod2='kuse gke_vst-main-prod_us-central1-a_prod1-usc1a'
alias kprodbg='kuse gke_vst-main-prod_us-east1_prodbg1-use1'
# Google Compute
alias gcloud='gcloud'
